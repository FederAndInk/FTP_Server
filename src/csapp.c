...
int Getnameinfo(const SA* sa, socklen_t salen, char* host, size_t hostlen, char* serv,
                size_t servlen, int flags)
{
  int r;
  if ((r = getnameinfo(sa, salen, host, hostlen, serv, servlen, flags)) != 0)
  {
...
void Pthread_create(pthread_t* tidp, pthread_attr_t* attrp, void* (*routine)(void*),
                    void* argp)
{
  int rc;
...
int Inet_pton(int af, const char* src, void* dst)
{
  ...
  if (r == 0)
  {
    app_error("Inet_pton error: src string does not correspond to a valid address "
              "representation");
  }
